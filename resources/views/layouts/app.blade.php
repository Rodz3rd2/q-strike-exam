...
<head>
   ...
   <!--  <link rel="stylesheet" type="text/css" href="{{ asset('bower_components/bootstrap/dist/css/bootstrap.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('bower_components/smoke/dist/css/smoke.css') }}"> -->
...
<body>
    ...
    <script type="text/javascript" src="{{ asset('bower_components/smoke/dist/js/smoke.js') }}"></script>
